...
public class FingerEnrollActivity extends AppCompatActivity implements FM220_Scanner_Interface {
...
//    }
    ...
    public void ScannerProgressFM220(final boolean DisplayImage, final Bitmap ScanImage, final boolean DisplayText, final String statusMessage) {
        FingerEnrollActivity.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                if (DisplayText) {
...
//write the bytes in file
    ...
    private void showSettingsDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(FingerEnrollActivity.this);
